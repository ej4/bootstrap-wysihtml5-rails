...
! function(a) {
	...
	function h(a) {
		c(window, "console") && b(window.console, "log") && window.console.log(a)
	}

	function i(a, b) {
		b ? window.alert(a) : h(a)
	}

	function j(a) {
		E.initialized = !0, E.supported = !1, i("Rangy is not supported on this page in your browser. Reason: " + a, E.config.alertOnFail)
	}

	function k(a) {
		i("Rangy warning: " + a, E.config.alertOnWarn)
	}
	...
	function m() {
		if (!E.initialized) {
			var a, c = !1,
				d = !1;
			b(document, "createRange") && (a = document.createRange(), A(a, x) && C(a, w) && (c = !0), a.detach());
			var e = g(document);
			if (!e || "body" != e.nodeName.toLowerCase()) return void j("No body element found");
			if (e && b(e, "createTextRange") && (a = e.createTextRange(), f(a) && (d = !0)), !c && !d) return void j("Neither Range nor TextRange are available");
			E.initialized = !0, E.features = {
				implementsDomRange: c,
				implementsTextRange: d
			};
			var i, k;
			for (var m in D)(i = D[m]) instanceof o && i.init(i, E);
			for (var n = 0, p = G.length; p > n; ++n) try {
				G[n](E)
			} catch (q) {
				k = "Rangy init listener threw an exception. Continuing. Detail: " + l(q), h(k)
			}
		}
	}
	...
	function n(a) {
		a = a || window, m();
		for (var b = 0, c = H.length; c > b; ++b) H[b](a)
	}
	...
	function p(a, b, c, d) {
		var e = new o(b, c, function(a) {
			if (!a.initialized) {
				a.initialized = !0;
				try {
					d(E, a), a.supported = !0
				} catch (c) {
					var e = "Module '" + b + "' failed to load: " + l(c);
					h(e)
				}
			}
		});
	...
	function r() {}
	var s = "function" == typeof a.define && a.define.amd,
		t = "object",
		u = "function",
		v = "undefined",
	...
	E.fail = j, E.warn = k, {}.hasOwnProperty ? E.util.extend = function(a, b, c) {
		var d, e;
		for (var f in b) b.hasOwnProperty(f) && (d = a[f], e = b[f], c && null !== d && "object" == typeof d && null !== e && "object" == typeof e && E.util.extend(d, e, !0), a[f] = e);
		return a
	...
	var F;
	b(document, "addEventListener") ? F = function(a, b, c) {
		a.addEventListener(b, c, !1)
	} : b(document, "attachEvent") ? F = function(a, b, c) {
		a.attachEvent("on" + b, c)
	} : j("Document does not have required addEventListener or attachEvent method"), E.util.addListener = F;
	var G = [];
	E.init = m, E.addInitListener = function(a) {
		E.initialized ? a(E) : G.push(a)
	};
	var H = [];
	E.addCreateMissingNativeApiListener = function(a) {
		H.push(a)
	}, E.createMissingNativeApi = n, o.prototype = {
		init: function() {
			for (var a, b, c = this.dependencies || [], d = 0, e = c.length; e > d; ++d) {
				if (b = c[d], a = D[b], !(a && a instanceof o)) throw new Error("required module '" + b + "' not found");
		...
		var b, c;
		2 == arguments.length ? (b = arguments[1], c = []) : (b = arguments[2], c = arguments[1]), p(!1, a, c, b)
	}, E.createCoreModule = function(a, b, c) {
		p(!0, a, b, c)
	}, E.RangePrototype = q, E.rangePrototype = new q, E.selectionPrototype = new r;
	var I = !1,
		J = function() {
			I || (I = !0, E.initialized || m())
		};
	return typeof window == v ? void j("No window found") : typeof document == v ? void j("No document found") : (b(document, "addEventListener") && document.addEventListener("DOMContentLoaded", J, !1), F(window, "load", J), s && a.define(function() {
		return E.amd = !0, E
	}), void(a.rangy = E))
	...
	function x(a) {
		...
		if (1 == a.nodeType) {
			var b = a.id ? ' id="' + a.id + '"' : "";
			return "<" + a.nodeName + b + ">[" + e(a) + "][" + a.childNodes.length + "][" + (a.innerHTML || "[innerHTML not supported]").slice(0, 25) + "]"
		}
		return a.nodeName
	}
...
}), rangy.createCoreModule("DomRange", ["DomUtil"], function(a) {
	function b(a, b) {
		return 3 != a.nodeType && (Q(a, b.startContainer) || Q(a, b.endContainer))
	}

	function c(a) {
		return a.document || R(a.startContainer)
	}

	function d(a) {
		return new M(a.parentNode, P(a))
	}

	function e(a) {
		return new M(a.parentNode, P(a) + 1)
	}

	function f(a, b, c) {
		var d = 11 == a.nodeType ? a.firstChild : a;
		return O(b) ? c == b.length ? K.insertAfter(a, b) : b.parentNode.insertBefore(a, 0 == c ? b : T(b, c)) : c >= b.childNodes.length ? b.appendChild(a) : b.insertBefore(a, b.childNodes[c]), d
	}

	function g(a, b, d) {
		if (A(a), A(b), c(b) != c(a)) throw new N("WRONG_DOCUMENT_ERR");
		var e = S(a.startContainer, a.startOffset, b.endContainer, b.endOffset),
			f = S(a.endContainer, a.endOffset, b.startContainer, b.startOffset);
	...
	function i(a, b, c) {
		...
		for (var f, g; f = a.next();)
			if (a.isPartiallySelectedSubtree()) {
				...
				for (d = K.createIterator(f); e = d.next();)
	...
	function l(a, b, c) {
		...
		return i(new n(a, !1), function(b) {
			if (!(e && !d.test(b.nodeType) || f && !c(b))) {
				...
				if (b != h || !O(h) || a.startOffset != h.length) {
					var i = a.endContainer;
					b == i && O(i) && 0 == a.endOffset || g.push(b)
				}
			}
		}), g
	}
	...
	function m(a) {
		...
		return "[" + b + "(" + K.inspectNode(a.startContainer) + ":" + a.startOffset + ", " + K.inspectNode(a.endContainer) + ":" + a.endOffset + ")]"
	}
	...
	function n(a, b) {
		if (this.range = a, this.clonePartiallySelectedTextNodes = b, !a.collapsed) {
			...
			this.sc === this.ec && O(this.sc) ? (this.isSingleCharacterDataNode = !0, this._first = this._last = this._next = this.sc) : (this._first = this._next = this.sc !== c || O(this.sc) ? U(this.sc, c, !0) : this.sc.childNodes[this.so], this._last = this.ec !== c || O(this.ec) ? U(this.ec, c, !0) : this.ec.childNodes[this.eo - 1])
		}
	}
	...
	function p(a) {
		return function(b, c) {
			for (var d, e = c ? b : b.parentNode; e;) {
				if (d = e.nodeType, W(a, d)) return e;
				e = e.parentNode
			}
			return null
		}
	...
	function q(a, b) {
		if (eb(a, b)) throw new o("INVALID_NODE_TYPE_ERR")
	}
	...
	function s(a, b) {
		if (!W(b, a.nodeType)) throw new o("INVALID_NODE_TYPE_ERR")
	}

	function t(a, b) {
		if (0 > b || b > (O(a) ? a.length : a.childNodes.length)) throw new N("INDEX_SIZE_ERR")
	}

	function u(a, b) {
		if (cb(a, !0) !== cb(b, !0)) throw new N("WRONG_DOCUMENT_ERR")
	}

	function v(a) {
		if (db(a, !0)) throw new N("NO_MODIFICATION_ALLOWED_ERR")
	}
	...
	function x(a) {
		return Y && K.isBrokenNode(a) || !W($, a.nodeType) && !cb(a, !0)
	}

	function y(a, b) {
		return b <= (O(a) ? a.length : a.childNodes.length)
	}

	function z(a) {
		return !!a.startContainer && !!a.endContainer && !x(a.startContainer) && !x(a.endContainer) && y(a.startContainer, a.startOffset) && y(a.endContainer, a.endOffset)
	}

	function A(a) {
		if (r(a), !z(a)) throw new Error("Range error: Range is no longer valid after DOM mutation (" + a.inspect() + ")")
	}
	...
	function B(a, b) {
		...
		var c = a.startContainer,
			...
			f = a.endOffset,
			g = c === e;
		O(e) && f > 0 && f < e.length && T(e, f, b), O(c) && d > 0 && d < c.length && (c = T(c, d, b), g ? (f -= d, e = c) : e == c.parentNode && f >= P(c) && f++, d = 0), a.setStartAndEnd(c, d, e, f)
	}

	function C(a) {
		a.START_TO_START = kb, a.START_TO_END = lb, a.END_TO_END = mb, a.END_TO_START = nb, a.NODE_BEFORE = ob, a.NODE_AFTER = pb, a.NODE_BEFORE_AND_AFTER = qb, a.NODE_INSIDE = rb
	}
	...
	function E(a, b) {
		return function() {
			...
			var c, d, f = this.startContainer,
				...
				j = new n(this, !0);
			f !== h && (c = U(f, h, !0), d = e(c), f = d.node, g = d.offset), i(j, v), j.reset();
			var k = a(j);
	...
	function F(c, f, g) {
		...
		function i(a, b, c) {
			var d = a.endContainer,
				e = a.endOffset;
			(b !== a.startContainer || c !== a.startOffset) && ((X(b) != X(d) || 1 == S(b, c, d, e)) && (d = b, e = c), f(a, b, c, d, e))
		}

		function l(a, b, c) {
			var d = a.startContainer,
				e = a.startOffset;
			(b !== a.endContainer || c !== a.endOffset) && ((X(b) != X(d) || -1 == S(b, c, d, e)) && (d = b, e = c), f(a, d, e, b, c))
		}
		var m = function() {};
		m.prototype = a.rangePrototype, c.prototype = new m, L.extend(c.prototype, {
			setStart: function(a, b) {
				r(this), q(a, !0), t(a, b), i(this, a, b)
			},
			setEnd: function(a, b) {
				r(this), q(a, !0), t(a, b), l(this, a, b)
			},
			...
			setEndAfter: h(!1, !1),
			collapse: function(a) {
				A(this), a ? f(this, this.startContainer, this.startOffset, this.startContainer, this.startOffset) : f(this, this.endContainer, this.endOffset, this.endContainer, this.endOffset)
			},
			selectNodeContents: function(a) {
				r(this), q(a, !0), f(this, a, 0, a, V(a))
			},
			...
			extractContents: E(k, f),
			deleteContents: E(j, f),
			canSurroundContents: function() {
				A(this), v(this.startContainer), v(this.endContainer);
				var a = new n(this, !0),
			...
			collapseToPoint: function(a, b) {
				r(this), q(a, !0), t(a, b), this.setStartAndEnd(a, b)
			}
		}), D(c)
	}

	function G(a) {
		a.collapsed = a.startContainer === a.endContainer && a.startOffset === a.endOffset, a.commonAncestorContainer = a.collapsed ? a.startContainer : K.getCommonAncestor(a.startContainer, a.endContainer)
	}

	function H(a, b, c, d, e) {
		a.startContainer = b, a.startOffset = c, a.endContainer = d, a.endOffset = e, a.document = K.getDocument(b), G(a)
	}

	function I(a) {
		r(a), a.startContainer = a.startOffset = a.endContainer = a.endOffset = a.document = null, a.collapsed = a.commonAncestorContainer = null
	}
	...
	var K = a.dom,
		...
		M = K.DomPosition,
		N = a.DOMException,
		O = K.isCharacterDataNode,
		P = K.getNodeIndex,
		Q = K.isOrIsAncestorOf,
		R = K.getDocument,
		S = K.comparePoints,
		T = K.splitDataNode,
		U = K.getClosestAncestorIn,
		V = K.getNodeLength,
		W = K.arrayContains,
		X = K.getRootContainer,
		Y = a.features.crashyTextNodes;
	n.prototype = {
		_current: null,
		_next: null,
		_first: null,
		...
		next: function() {
			...
			return a && (this._next = a !== this._last ? a.nextSibling : null, O(a) && this.clonePartiallySelectedTextNodes && (a === this.ec && (a = a.cloneNode(!0)).deleteData(this.eo, a.length - this.eo), this._current === this.sc && (a = a.cloneNode(!0)).deleteData(0, this.so))), a
		},
		remove: function() {
			var a, b, c = this._current;
			!O(c) || c !== this.sc && c !== this.ec ? c.parentNode && c.parentNode.removeChild(c) : (a = c === this.sc ? this.so : 0, b = c === this.ec ? this.eo : c.length, a != b && c.deleteData(a, b - a))
		},
		...
		getSubtreeIterator: function() {
			...
			if (this.isSingleCharacterDataNode) a = this.range.cloneRange(), a.collapse(!1);
				...
				a = new J(c(this.range));
				var b = this._current,
					d = b,
					e = 0,
					f = b,
					g = V(b);
				Q(b, this.sc) && (d = this.sc, e = this.so), Q(b, this.ec) && (f = this.ec, g = this.eo), H(a, d, e, f, g)
			}
	...
	var Z = [1, 3, 4, 5, 7, 8, 10],
		...
		gb = !1;
	try {
		fb.innerHTML = "<b>x</b>", gb = 3 == fb.firstChild.nodeType
	} catch (hb) {}
	...
	var ib = gb ? function(a) {
			...
			var d = null;
			return 1 == b.nodeType ? d = b : O(b) && (d = K.parentElement(b)), d = null === d || "HTML" == d.nodeName && K.isHtmlNamespace(R(d).documentElement) && K.isHtmlNamespace(d) ? c.createElement("body") : d.cloneNode(!1), d.innerHTML = a, K.fragmentFromNodeChildren(d)
		} : function(a) {
			r(this);
			var b = c(this),
				d = b.createElement("body");
			return d.innerHTML = a, K.fragmentFromNodeChildren(d)
		},
		...
		qb = 2,
		rb = 3;
	L.extend(a.rangePrototype, {
		compareBoundaryPoints: function(a, b) {
			A(this), u(this.startContainer, b.startContainer);
			var c, d, e, f, g = a == nb || a == kb ? "start" : "end",
				h = a == lb || a == kb ? "start" : "end";
			return c = this[g + "Container"], d = this[g + "Offset"], e = b[h + "Container"], f = b[h + "Offset"], S(c, d, e, f)
		},
		insertNode: function(a) {
			if (A(this), s(a, ab), v(this.startContainer), Q(a, this.startContainer)) throw new N("HIERARCHY_REQUEST_ERR");
		...
		cloneContents: function() {
			...
			if (this.startContainer === this.endContainer && O(this.startContainer)) return a = this.startContainer.cloneNode(!0), a.data = a.data.slice(this.startOffset, this.endOffset), b = c(this).createDocumentFragment(), b.appendChild(a), b;
			var d = new n(this, !0);
		...
		surroundContents: function(a) {
			if (s(a, bb), !this.canSurroundContents()) throw new o("BAD_BOUNDARYPOINTS_ERR");
		...
		cloneRange: function() {
			A(this);
			for (var a, b = new J(c(this)), d = jb.length; d--;) a = jb[d], b[a] = this[a];
			return b
		},
		toString: function() {
			A(this);
			var a = this.startContainer;
			if (a === this.endContainer && O(a)) return 3 == a.nodeType || 4 == a.nodeType ? a.data.slice(this.startOffset, this.endOffset) : "";
			var b = [],
				c = new n(this, !0);
		...
		comparePoint: function(a, b) {
			return A(this), w(a, "HIERARCHY_REQUEST_ERR"), u(a, this.startContainer), S(a, b, this.startContainer, this.startOffset) < 0 ? -1 : S(a, b, this.endContainer, this.endOffset) > 0 ? 1 : 0
		},
		...
		intersectsNode: function(a, b) {
			if (A(this), w(a, "NOT_FOUND_ERR"), R(a) !== c(this)) return !1;
			var d = a.parentNode,
				e = P(a);
			w(d, "NOT_FOUND_ERR");
			var f = S(d, e, this.endContainer, this.endOffset),
				g = S(d, e + 1, this.startContainer, this.startOffset);
			return b ? 0 >= f && g >= 0 : 0 > f && g > 0
		},
		isPointInRange: function(a, b) {
			return A(this), w(a, "HIERARCHY_REQUEST_ERR"), u(a, this.startContainer), S(a, b, this.startContainer, this.startOffset) >= 0 && S(a, b, this.endContainer, this.endOffset) <= 0
		},
		...
		intersection: function(a) {
			if (this.intersectsRange(a)) {
				var b = S(this.startContainer, this.startOffset, a.startContainer, a.startOffset),
					c = S(this.endContainer, this.endOffset, a.endContainer, a.endOffset),
					d = this.cloneRange();
		...
		union: function(a) {
			if (this.intersectsOrTouchesRange(a)) {
				...
				return -1 == S(a.startContainer, a.startOffset, this.startContainer, this.startOffset) && b.setStart(a.startContainer, a.startOffset), 1 == S(a.endContainer, a.endOffset, this.endContainer, this.endOffset) && b.setEnd(a.endContainer, a.endOffset), b
			}
		...
		containsNodeContents: function(a) {
			return this.comparePoint(a, 0) >= 0 && this.comparePoint(a, V(a)) <= 0
		},
		...
		getNodes: function(a, b) {
			return A(this), l(this, a, b)
		},
		getDocument: function() {
			return c(this)
		},
		collapseBefore: function(a) {
			r(this), this.setEndBefore(a), this.collapse(!1)
		},
		collapseAfter: function(a) {
			r(this), this.setStartAfter(a), this.collapse(!0)
		},
		getBookmark: function(b) {
			var d = c(this),
				e = a.createRange(d);
			b = b || K.getBody(d), e.selectNodeContents(b);
	...
	}), a.DomRange = J, a.RangeException = o
	...
	if (a.features.implementsDomRange && ! function() {
		function d(a) {
			for (var b, c = n.length; c--;) b = n[c], a[b] = a.nativeRange[b];
		...
		try {
			p.setStart(o, 1), l.setStart = function(a, b) {
				this.nativeRange.setStart(a, b), d(this)
			}, l.setEnd = function(a, b) {
		...
		l.setStartBefore = m("setStartBefore", "setEndBefore"), l.setStartAfter = m("setStartAfter", "setEndAfter"), l.setEndBefore = m("setEndBefore", "setStartBefore"), l.setEndAfter = m("setEndAfter", "setStartAfter"), l.selectNodeContents = function(a) {
			this.setStartAndEnd(a, 0, e.getNodeLength(a))
		}, p.selectNodeContents(o), p.setEnd(o, 3);
		var r = document.createRange();
		r.selectNodeContents(o), r.setEnd(o, 4), r.setStart(o, 2), l.compareBoundaryPoints = -1 == p.compareBoundaryPoints(p.START_TO_END, r) && 1 == p.compareBoundaryPoints(p.END_TO_START, r) ? function(a, b) {
		...
		var t = s.firstChild,
			u = i(document);
		u.appendChild(s), p.setStart(t, 1), p.setEnd(t, 2), p.deleteContents(), "13" == t.data && (l.deleteContents = function() {
			this.nativeRange.deleteContents(), d(this)
		}, l.extractContents = function() {
			var a = this.nativeRange.extractContents();
			return d(this), a
		}), u.removeChild(s), u = null, f.isHostMethod(p, "createContextualFragment") && (l.createContextualFragment = function(a) {
			return this.nativeRange.createContextualFragment(a)
		}), i(document).removeChild(o), p.detach(), r.detach(), l.getName = function() {
			return "WrappedRange"
		...
		if (d = function(a) {
			...
			"undefined" == typeof p.Range && (p.Range = d), a.createNativeRange = function(a) {
	...
	D.areHostMethods(R, ["addRange", "getRangeAt", "removeAllRanges"]) && typeof R.rangeCount == B && J.implementsDomRange && ! function() {
		...
		if (b) {
			...
			if (l.setStart(k, 1), l.collapse(!0), b.addRange(l), Y = 1 == b.rangeCount, b.removeAllRanges(), !d) {
				var m = l.cloneRange();
				l.setStart(k, 0), m.setEnd(k, 3), m.setStart(k, 2), b.addRange(l), b.addRange(m), X = 2 == b.rangeCount, m.detach()
			}
			for (i.removeChild(j), b.removeAllRanges(), l.detach(), h = 0; c > h; ++h) 0 == h && f ? Z ? Z(b, e[h]) : (a.warn("Rangy initialization: original selection was backwards but selection has been restored forwards because browser does not support Selection.extend"), b.addRange(e[h])) : b.addRange(e[h])
		}
	...
	!Q && U && J.implementsDomRange ? (hb = g, db.isBackward = function() {
		...
		t(null, "deleteAll")
	}, r.inspect = x, r.isDirectionBackward = c, a.Selection = r, a.selectionPrototype = db, a.addCreateMissingNativeApiListener(function(a) {
	...
	function d(a, b) {
		var c, d = "selectionBoundary_" + +new Date + "_" + ("" + Math.random()).slice(2),
			...
			f = a.cloneRange();
		return f.collapse(b), c = e.createElement("span"), c.id = d, c.style.lineHeight = "0", c.style.display = "none", c.className = "rangySelectionBoundary", c.appendChild(e.createTextNode(p)), f.insertNode(c), f.detach(), c
	}
...
Base.extend = function(a, b) {
	...
	var c = navigator.userAgent,
		...
		e = -1 !== c.indexOf("MSIE") && -1 === c.indexOf("Opera"),
		f = -1 !== c.indexOf("Gecko") && -1 === c.indexOf("KHTML"),
		g = -1 !== c.indexOf("AppleWebKit/"),
		h = -1 !== c.indexOf("Chrome/"),
		i = -1 !== c.indexOf("Opera/");
	return {
		USER_AGENT: c,
		supported: function() {
			var c = this.USER_AGENT.toLowerCase(),
				e = "contentEditable" in d,
		...
		supportsEvent: function(a) {
			return "on" + a in d || function() {
				return d.setAttribute("on" + a, "return;"), "function" == typeof d["on" + a]
			}()
		},
		...
		supportsCommand: function() {
			var a = {
					formatBlock: e,
					insertUnorderedList: e || g,
					insertOrderedList: e || g
				},
				b = {
					insertHTML: f
				};
...
}(), wysihtml5.dom.getTextNodes = function(a) {
	var b = [];
	for (a = a.firstChild; a; a = a.nextSibling) 3 == a.nodeType ? b.push(a) : b = b.concat(wysihtml5.dom.getTextNodes(a));
	return b
...
function(a) {
	...
	function a(a, c) {
		wysihtml5.lang.object(o).merge(n).merge(c.rules).get();
		var d, e, f, g = c.context || a.ownerDocument || document,
			h = g.createDocumentFragment(),
			i = "string" == typeof a,
			j = !1;
		for (c.clearInternals === !0 && (j = !0), c.uneditableClass && (p = c.uneditableClass), d = i ? wysihtml5.dom.getAsDom(a, g) : a; d.firstChild;) f = d.firstChild, e = b(f, c.cleanUp, j), e && h.appendChild(e), f !== e && d.removeChild(f);
	...
	function b(a, c, d) {
		var e, f, g, h = a.nodeType,
			...
			m = k[h],
			n = 0;
		if (p && 1 === h && wysihtml5.dom.hasClass(a, p)) return a;
		if (f = m && m(a, d), !f) {
			if (f === !1) {
		...
		if (c && f.nodeName.toLowerCase() === l && (!f.childNodes.length || /^\s*$/gi.test(f.innerHTML) && (d || "_wysihtml5-temp-placeholder" !== a.className && "rangySelectionBoundary" !== a.className) || !f.attributes.length)) {
	...
	function c(a, b) {
		...
		return e = a.ownerDocument.createElement(c.rename_tag || i), g(a, e, c, b), f(a, e, c), c.one_of_type && !d(a, o, c.one_of_type, b) ? c.remove_action && "unwrap" == c.remove_action ? !1 : null : (a = null, e.normalize && e.normalize(), e)
	}
	...
	function e(a, b) {
		...
		if (b.methods)
			for (var k in b.methods)
				if (b.methods.hasOwnProperty(k) && v[k] && v[k](a)) return !0;
		if (i && b.classes) {
			i = i.replace(/^\s+/g, "").replace(/\s+$/g, "").split(m), c = i.length;
			for (var l = 0; c > l; l++)
			...
			for (d in b.styles)
				if (b.styles.hasOwnProperty(d))
					for (var n = j.length; n--;)
						if (g = j[n].split(":"), g[0].replace(/\s/g, "").toLowerCase() === d && (b.styles[d] === !0 || 1 === b.styles[d] || wysihtml5.lang.array(b.styles[d]).contains(g[1].replace(/\s/g, "").toLowerCase()))) return !0
		}
		if (b.attrs)
			for (e in b.attrs)
	...
	function g(a, b, c, d) {
		var e, f, g, i, j, k, l = {},
			...
			A = [],
			B = [];
		if (r && (l = wysihtml5.lang.object(r).clone()), v)
			for (i in v) k = s[v[i]], k && (oldAttribute = h(a, i), (oldAttribute || "alt" === i && "IMG" == a.nodeName) && (j = k(oldAttribute), "string" == typeof j && (l[i] = j)));
		if (n && y.push(n), p)
			for (i in p) k = u[p[i]], k && (g = k(h(a, i)), "string" == typeof g && y.push(g));
		if (q)
			for (i in q) k = t[q[i]], k && (newStyle = k(h(a, i)), "string" == typeof newStyle && z.push(newStyle));
		if ("string" == typeof w && "any" === w && a.getAttribute("class")) l["class"] = a.getAttribute("class");
		else {
			for (d || (w["_wysihtml5-temp-placeholder"] = 1, w._rangySelectionBoundary = 1, w["wysiwyg-tmp-selected-cell"] = 1), B = a.getAttribute("class"), B && (y = y.concat(B.split(m))), e = y.length; e > x; x++) f = y[x], w[f] && A.push(f);
			A.length && (l["class"] = wysihtml5.lang.array(A).unique().join(" "))
		}
		l["class"] && d && (l["class"] = l["class"].replace("wysiwyg-tmp-selected-cell", ""), /^\s*$/g.test(l["class"]) && delete l.class), z.length && (l.style = wysihtml5.lang.array(z).unique().join(" "));
		for (i in l) try {
			b.setAttribute(i, l[i])
		} catch (C) {}
		l.src && ("undefined" != typeof l.width && b.setAttribute("width", l.width), "undefined" != typeof l.height && b.setAttribute("height", l.height))
	}
	...
	function j(a) {
		...
		if (!b || b.nodeType !== wysihtml5.TEXT_NODE) {
			var c = a.data.replace(r, "");
			return a.ownerDocument.createTextNode(c)
		}
		b.data = a.data.replace(r, "") + b.data.replace(r, "")
	}
	var k = {
			1: c,
			3: j
		...
		o = {},
		p = !1,
		q = !wysihtml5.browser.supportsGetAttributeCorrectly(),
		r = /\uFEFF/g,
		s = {
			url: function() {
				var a = /^https?:\/\//i;
...
function(a) {
	a.simulatePlaceholder = function(b, c, d) {
		var e = "placeholder",
			f = function() {
				c.hasPlaceholderSet() && c.clear(), c.placeholderSet = !1, a.removeClass(c.element, e)
			},
			g = function() {
...
function(a) {
	...
	a.Selection = Base.extend({
		...
		caretIsFirstInSelection: function() {
			var a = rangy.createRange(this.doc),
				b = this.getSelection();
			return a.selectNodeContents(this.getRange().commonAncestorContainer), a.collapse(!0), this.isCollapsed() && (a.startContainer === b.anchorNode || a.endContainer === b.anchorNode) && a.startOffset === b.anchorOffset
		},
		...
		_detectInlineRangeProblems: function(a) {
			return position = e.compareDocumentPosition(a.startContainer, a.endContainer), 0 == a.endOffset && 4 & position
		},
		getRange: function(a) {
...
function(a, b) {
	...
	function k(a, b) {
		return a.className.replace(s, " ") == b.className.replace(s, " ")
	}

	function l(a) {
		for (var b = a.parentNode; a.firstChild;) b.insertBefore(a.firstChild, a);
		b.normalize && b.normalize(), b.removeChild(a)
	}
	...
	function o(a, c, d, e) {
		...
		return c == a ? f : o(a, f.parentNode, b.dom.getNodeIndex(f), e)
	}
	...
	function q(a, b, c, d, e, f, g) {
		this.tagNames = a || [r], this.cssClass = b || (b === !1 ? !1 : ""), this.similarClassRegExp = c, this.cssStyle = e || "", this.similarStyleRegExp = f, this.normalize = d, this.applyToAnyTagName = !1, this.container = g
	}
	var r = "span",
		s = /\s+/g;
	p.prototype = {
		...
		postApply: function(a, b) {
			for (var c, d, e, f = a[0], g = a[a.length - 1], h = [], i = f, j = g, k = 0, l = g.length, m = 0, n = a.length; n > m; ++m) d = a[m], e = null, d && d.parentNode && (e = this.getAdjacentMergeableTextNode(d.parentNode, !1)), e ? (c || (c = new p(e), h.push(c)), c.textNodes.push(d), d === f && (i = c.firstTextNode, k = i.length), d === g && (j = c.firstTextNode, l = c.getLength())) : c = null;
			if (g && g.parentNode) {
				var o = this.getAdjacentMergeableTextNode(g.parentNode, !0);
				o && (c || (c = new p(g), h.push(c)), c.textNodes.push(o))
			}
			if (h.length) {
		...
		areElementsMergeable: function(a, c) {
			return b.dom.arrayContains(this.tagNames, (a.tagName || "").toLowerCase()) && b.dom.arrayContains(this.tagNames, (c.tagName || "").toLowerCase()) && k(a, c) && m(a, c)
		},
		...
		undoToTextNode: function(a, b, c, d) {
			...
			if (!b.containsNode(f)) {
				var i = b.cloneRange();
				i.selectNode(f), i.isPointInRange(b.endContainer, b.endOffset) && n(b.endContainer, b.endOffset) && (o(f, b.endContainer, b.endOffset, this.container), b.setEndAfter(f)), i.isPointInRange(b.startContainer, b.startOffset) && n(b.startContainer, b.startOffset) && (f = o(f, b.startContainer, b.startOffset, this.container))
			}!e && this.similarClassRegExp && g(f, this.similarClassRegExp), e && this.similarStyleRegExp && (h = "change" === j(f, this.cssStyle, this.similarStyleRegExp)), this.isRemovable(f) && !h && l(f)
		},
		applyToRange: function(b) {
			for (var c, d = b.length; d--;) {
				...
				if (b[d].splitBoundaries(), c = b[d].getNodes([a.TEXT_NODE]), c.length) {
					for (var g, h = 0, i = c.length; i > h; ++h) g = c[h], this.getAncestorWithClass(g) || this.applyToTextNode(g), this.getAncestorWithStyle(g) || this.applyToTextNode(g);
					b[d].setStart(c[0], 0), g = c[c.length - 1], b[d].setEnd(g, g.length), this.normalize && this.postApply(c, b[d])
				}
			}
		},
		undoToRange: function(b) {
			for (var c, d, e, f, g = b.length; g--;) {
				if (c = b[g].getNodes([a.TEXT_NODE]), c.length) b[g].splitBoundaries(), c = b[g].getNodes([a.TEXT_NODE]);
				else {
					var h = b[g].endContainer.ownerDocument,
						i = h.createTextNode(a.INVISIBLE_SPACE);
					b[g].insertNode(i), b[g].selectNode(i), c = [i]
				}
				for (var j = 0, k = c.length; k > j; ++j) b[g].isValid() && (d = c[j], e = this.getAncestorWithClass(d), f = this.getAncestorWithStyle(d), e ? this.undoToTextNode(d, b[g], e) : f && this.undoToTextNode(d, b[g], !1, f));
				1 == k ? this.selectNode(b[g], c[0]) : (b[g].setStart(c[0], 0), d = c[c.length - 1], b[g].setEnd(d, d.length), this.normalize && this.postApply(c, b[g]))
			}
		},
		selectNode: function(b, c) {
		...
		isAppliedToRange: function(b) {
			for (var c, d, e = [], f = b.length; f--;) {
				if (d = b[f].getNodes([a.TEXT_NODE]), !d.length) return c = this.getAncestorWithClass(b[f].startContainer), c || (c = this.getAncestorWithStyle(b[f].startContainer)), c ? [c] : !1;
				for (var g, h = 0, i = d.length; i > h; ++h) g = this.getTextSelectedByRange(d[h], b[f]), c = this.getAncestorWithClass(d[h]), c || (c = this.getAncestorWithStyle(d[h])), c && "" != g && e.push(c)
			}
			return e.length ? e : !1
		},
...
function(a) {
	...
	a.commands.formatBlock = {
		exec: function(f, g, m, n, o, p, q) {
			var r, s, t, u, v = (f.doc, this.state(f, g, m, n, o, p, q)),
				w = f.config.useLineBreaks,
				x = w ? "DIV" : "P";
			return m = "string" == typeof m ? m.toUpperCase() : m, v.length ? void f.selection.executeAndRestoreRangy(function() {
				for (var b = v.length; b--;) {
					if (o && (s = d(v[b], o)), q && (u = e(v[b], q)), (u || s) && null === m && v[b].nodeName != x) return;
					var c = i(v[b]),
						f = j(v[b]);
					c || f || !w && "P" !== m ? k.renameElement(v[b], "P" === m ? "DIV" : x) : (a.dom.lineBreaks(v[b]).add(), k.replaceWithChildNodes(v[b]))
				}
				...
				for (var a = r.length; a--;) blockElement = k.getParentElement(r[a], {
					nodeName: l
				}), blockElement == f.element && (blockElement = null), blockElement && (m && (blockElement = k.renameElement(blockElement, m)), n && b(blockElement, n, o), p && c(blockElement, p, q), t = !0)
			}), !t)) && h(f, {
				nodeName: m || x,
				className: n || null,
				cssStyle: p || null
...
function(a) {
	...
	a.commands.formatInline = {
		exec: function(a, b, d, e, f, g, h, i, j) {
			...
			return ownRanges = a.selection.getOwnRanges(), ownRanges && 0 != ownRanges.length ? (a.selection.getSelection().removeAllRanges(), c(d, e, f, g, h, a.element).toggleRange(ownRanges), void(i ? j || a.cleanUp() : (k.setStart(ownRanges[0].startContainer, ownRanges[0].startOffset), k.setEnd(ownRanges[ownRanges.length - 1].endContainer, ownRanges[ownRanges.length - 1].endOffset), a.selection.setSelection(k), a.selection.executeAndRestore(function() {
				j || a.cleanUp()
			}, !0, !0)))) : !1
		},
		...
		state: function(b, e, f, g, h, i, j) {
			var k, l = b.doc,
				m = d[f] || f;
			return a.dom.hasElementWithTagName(l, f) || a.dom.hasElementWithTagName(l, m) ? g && !a.dom.hasElementWithClassName(l, g) ? !1 : (k = b.selection.getOwnRanges(), k && 0 !== k.length ? c(f, g, h, i, j, b.element).isAppliedToRange(k) : !1) : !1
		}
	}
}(wysihtml5),
function(a) {
	...
	var b = function(a, b) {
		...
		c = function(c, d, e) {
			...
			if (c) {
				...
				otherNodeName = "UL" === d ? "OL" : "UL", b(c, d) ? f.el = c : b(c, otherNodeName) ? f = {
					el: c,
					other: !0
				} : g && (b(g.parentNode, d) ? f.el = g.parentNode : b(g.parentNode, otherNodeName) && (f = {
					el: g.parentNode,
					other: !0
				}))
			}
...
function(a) {
	...
	a.UndoManager = a.lang.Dispatcher.extend({
		...
		transact: function() {
			var b = this.historyStr[this.position - 1],
				c = this.composer.getValue(!1, !1);
			if (c !== b) {
				var d = this.historyStr.length = this.historyDom.length = this.position;
				d > f && (this.historyStr.shift(), this.historyDom.shift(), this.position--), this.position++;
				var e, i, j = this.composer.selection.getRange(),
					k = j && j.startContainer ? j.startContainer : this.element,
					l = j && j.startOffset ? j.startOffset : 0;
				k.nodeType === a.ELEMENT_NODE ? e = k : (e = k.parentNode, i = this.getChildNodeIndex(e, k)), e.setAttribute(h, l), "undefined" != typeof i && e.setAttribute(g, i);
				var m = this.element.cloneNode(!!c);
				this.historyDom.push(m), this.historyStr.push(c), e.removeAttribute(h), e.removeAttribute(g)
			}
		},
		undo: function() {
...
function(a) {
	var b = a.dom,
		...
		f = function(a, b, c, d) {
			if (b.isCollapsed())
				...
				var f = b.caretIsBeforeUneditable();
				f && (a.preventDefault(), e(b, f, c))
	...
	a.views.Composer.prototype.observe = function() {
		...
		}), this.config.handleTables && (this.doc.execCommand && a.browser.supportsCommand(this.doc, "enableObjectResizing") && a.browser.supportsCommand(this.doc, "enableInlineTableEditing") && setTimeout(function() {
			e.doc.execCommand("enableObjectResizing", !1, "false"), e.doc.execCommand("enableInlineTableEditing", !1, "false")
		}, 0), this.tableSelection = a.quirks.tableCellsSelection(j, e.parent)), b.observe(k, "focus", function() {
			e.parent.fire("focus").fire("focus:composer"), setTimeout(function() {
				h = e.getValue(!1, !1)
			}, 0)
		}), b.observe(k, "blur", function() {
			h !== e.getValue(!1, !1) && e.parent.fire("change").fire("change:composer"), e.parent.fire("blur").fire("blur:composer")
		}), b.observe(j, "dragenter", function() {
			e.parent.fire("unset_placeholder")
		}), b.observe(j, l, function() {
			setTimeout(function() {
...
function(a) {
	"function" == typeof define && define.amd ? define("bootstrap.wysihtml5", ["jquery", "wysihtml5", "bootstrap.wysihtml5.templates", "bootstrap.wysihtml5.commands"], a) : a(jQuery, wysihtml5)
}(function(a, b) {
	var c = function(a, b) {
		"use strict";
		...
		d.prototype = {
			...
			createToolbar: function(b, d) {
				...
				for (var k in d.toolbar) d.toolbar[k] && (h.append(c(k, j, d)), "html" === k && this.initHtml(h), "link" === k && this.initInsertLink(h), "image" === k && this.initInsertImage(h));
